...
import { User, Mail, Phone, MapPin, Globe, Users, MessageSquare, BookOpen, Clock, Send, CheckCircle } from 'lucide-react';
...
const ContactForm = () => {
 ...
 const handleSubmit = async (e) => {
   ...
   try {
     ...
     const response = await fetch("https://sheetdb.io/api/v1/mmjkvayglluz1", {
       method: "POST",
       headers: {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center max-w-2xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Your message has been submitted successfully. Our team will contact you within 24 hours.
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50 pb-15">
      ...
      <div className="relative mb-16 bg-gradient-to-br from-teal-900 via-cyan-800 to-teal-700 py-20 overflow-hidden">
        ...
        <div className="relative pt-20 z-10 max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl text-cyan-100 max-w-3xl mx-auto">
            Get in touch with us by filling out the form below. Our team will respond to you shortly.
          </p>
        </div>
      </div>
